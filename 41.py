# Lets do more shall we?
# A continuation from file 40.py
# Yep

from sys import exit
from random import randint

def death(): # We would need this in our code cheat
...
def princess_lives_here():
	...
	if eat_it == "eat it":
		...
		print "Then she smiles and cried and thans you for saving her"
...
def gold_koi_pond():
	...
	if feed_it == "do not feed it":
		...
		print "and finally rolls over and poops a magic diamon into the air."
		print "at your feet."
...
def bear_with_sword():
	...
	if give_it == "give it":
		...
		print "It tries to put your hand back on, but you collaps."
		print "The last thing you see is the bear shrug and eat you."
		return 'death'

	elif give_it == "say no":
		print "The bear looks shocked. Nobosy ever told a bear"
		print "With a broadsword 'no'. It asks, "
		print '"Is it beacause it\'s not a katana? I could go get one!"'
